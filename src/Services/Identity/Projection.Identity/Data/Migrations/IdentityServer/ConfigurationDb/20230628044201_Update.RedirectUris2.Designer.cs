...
namespace Projection.Identity.Data.IdentityServer.ConfigurationDb
{
    ...
    [Migration("20230628044201_Update.RedirectUris2")]
    partial class UpdateRedirectUris2
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Duende.IdentityServer.EntityFramework.Entities.ApiScope", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            Created = new DateTime(2023, 6, 28, 4, 42, 1, 569, DateTimeKind.Utc).AddTicks(5360),
            ...
            modelBuilder.Entity("Duende.IdentityServer.EntityFramework.Entities.ClientSecret", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            ClientId = 2,
                            Created = new DateTime(2023, 6, 28, 4, 42, 1, 569, DateTimeKind.Utc).AddTicks(5920),
                            Type = "SharedSecret",
