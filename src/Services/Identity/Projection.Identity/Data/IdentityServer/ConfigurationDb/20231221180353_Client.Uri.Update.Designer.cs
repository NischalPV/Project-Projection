...
namespace Projection.Identity.Data.IdentityServer.ConfigurationDb
{
    ...
    [Migration("20231221180353_Client.Uri.Update")]
    partial class ClientUriUpdate
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Duende.IdentityServer.EntityFramework.Entities.ApiScope", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            Created = new DateTime(2023, 12, 21, 18, 3, 52, 70, DateTimeKind.Utc).AddTicks(2906),
            ...
            modelBuilder.Entity("Duende.IdentityServer.EntityFramework.Entities.ClientPostLogoutRedirectUri", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            ClientId = 1,
                            PostLogoutRedirectUri = "http://localhost:5194/signout-callback-oidc"
                        },
                        new
                        {
                            Id = 2,
            ...
            modelBuilder.Entity("Duende.IdentityServer.EntityFramework.Entities.ClientRedirectUri", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            ClientId = 1,
                            RedirectUri = "http://localhost:5194/signin-oidc"
                        },
                        new
                        {
                            Id = 2,
            ...
            modelBuilder.Entity("Duende.IdentityServer.EntityFramework.Entities.ClientSecret", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            ClientId = 1,
                            Created = new DateTime(2023, 12, 21, 18, 3, 52, 70, DateTimeKind.Utc).AddTicks(4198),
                            Type = "SharedSecret",
                        ...
                        new
                        {
                            Id = 2,
                            ClientId = 2,
                            Created = new DateTime(2023, 12, 21, 18, 3, 52, 70, DateTimeKind.Utc).AddTicks(4199),
                            Type = "SharedSecret",
                            Value = "projection@2023"
                        });
                });
