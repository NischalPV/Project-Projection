...
namespace Projection.Identity.Data.IdentityServer.ConfigurationDb
{
    ...
    [Migration("20230627152524_Update.RedirectUris")]
    partial class UpdateRedirectUris
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Duende.IdentityServer.EntityFramework.Entities.ApiScope", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            Created = new DateTime(2023, 6, 27, 15, 25, 23, 861, DateTimeKind.Utc).AddTicks(7050),
            ...
            modelBuilder.Entity("Duende.IdentityServer.EntityFramework.Entities.ClientRedirectUri", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            Id = 2,
                            ClientId = 2,
                            RedirectUri = "http://localhost:6002/swagger/oauth2-redirect"
                        },
                        new
                        {
                            Id = 3,
                        ...
                        new
                        {
                            Id = 4,
                            ClientId = 4,
                            RedirectUri = "https://projection360-api.azurewebsites.net/swagger/oauth2-redirect"
                        });
                });
            ...
            modelBuilder.Entity("Duende.IdentityServer.EntityFramework.Entities.ClientSecret", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            ClientId = 2,
                            Created = new DateTime(2023, 6, 27, 15, 25, 23, 861, DateTimeKind.Utc).AddTicks(7590),
                            Type = "SharedSecret",
