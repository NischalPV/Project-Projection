...
namespace Projection.Identity.Data.Migrations.IdentityServer.ConfigurationDb
{
    ...
    [Migration("20240511193342_InitialSql")]
            ...
            modelBuilder.Entity("Duende.IdentityServer.EntityFramework.Entities.ClientSecret", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            ClientId = 1,
                            Created = new DateTime(2024, 5, 11, 19, 33, 41, 944, DateTimeKind.Utc).AddTicks(5351),
                            Type = "SharedSecret",
                        ...
                        new
                        {
                            Id = 2,
                            ClientId = 2,
                            Created = new DateTime(2024, 5, 11, 19, 33, 41, 944, DateTimeKind.Utc).AddTicks(5720),
                            Type = "SharedSecret",
                            Value = "bUE6r4ekrGN8HLmiko/LoLEC1KIiDyqwNtte4dwjrHY="
                        },
                        new
                        {
                            Id = 4,
                            ClientId = 4,
                            Created = new DateTime(2024, 5, 11, 19, 33, 41, 944, DateTimeKind.Utc).AddTicks(5740),
                            Type = "SharedSecret",
                            Value = "bUE6r4ekrGN8HLmiko/LoLEC1KIiDyqwNtte4dwjrHY="
                        });
                });
