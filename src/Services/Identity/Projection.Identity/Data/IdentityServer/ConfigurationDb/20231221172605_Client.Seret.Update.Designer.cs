...
namespace Projection.Identity.Data.IdentityServer.ConfigurationDb
{
    ...
    [Migration("20231221172605_Client.Seret.Update")]
    partial class ClientSeretUpdate
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Duende.IdentityServer.EntityFramework.Entities.ApiScope", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            Created = new DateTime(2023, 12, 21, 17, 26, 4, 554, DateTimeKind.Utc).AddTicks(1854),
            ...
            modelBuilder.Entity("Duende.IdentityServer.EntityFramework.Entities.ClientSecret", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            ClientId = 1,
                            Created = new DateTime(2023, 12, 21, 17, 26, 4, 554, DateTimeKind.Utc).AddTicks(4504),
                            Type = "SharedSecret",
                        ...
                        new
                        {
                            Id = 2,
                            ClientId = 2,
                            Created = new DateTime(2023, 12, 21, 17, 26, 4, 554, DateTimeKind.Utc).AddTicks(4510),
                            Type = "SharedSecret",
                            Value = "projection@2023"
                        });
                });
