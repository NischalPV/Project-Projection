...
namespace Projection.Identity.Data.IdentityServer.ConfigurationDb
{
    ...
    [Migration("20230628044444_Update.GrantType")]
    partial class UpdateGrantType
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Duende.IdentityServer.EntityFramework.Entities.ApiScope", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            Created = new DateTime(2023, 6, 28, 4, 44, 44, 666, DateTimeKind.Utc).AddTicks(380),
            ...
            modelBuilder.Entity("Duende.IdentityServer.EntityFramework.Entities.ClientSecret", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            ClientId = 2,
                            Created = new DateTime(2023, 6, 28, 4, 44, 44, 666, DateTimeKind.Utc).AddTicks(1060),
                            Type = "SharedSecret",
