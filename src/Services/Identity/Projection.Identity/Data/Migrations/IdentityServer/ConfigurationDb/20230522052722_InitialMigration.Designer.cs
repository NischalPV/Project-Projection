...
namespace Projection.Identity.Data.Migrations.IdentityServer.ConfigurationDb
{
    ...
    [Migration("20230522052722_InitialMigration")]
            ...
            modelBuilder.Entity("Duende.IdentityServer.EntityFramework.Entities.ApiScope", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            Created = new DateTime(2023, 5, 22, 5, 27, 22, 661, DateTimeKind.Utc).AddTicks(3040),
            ...
            modelBuilder.Entity("Duende.IdentityServer.EntityFramework.Entities.ClientSecret", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            ClientId = 2,
                            Created = new DateTime(2023, 5, 22, 5, 27, 22, 661, DateTimeKind.Utc).AddTicks(3650),
                            Type = "SharedSecret",
