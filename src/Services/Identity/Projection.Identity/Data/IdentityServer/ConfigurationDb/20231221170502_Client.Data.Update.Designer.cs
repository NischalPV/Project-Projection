...
namespace Projection.Identity.Data.IdentityServer.ConfigurationDb
{
    ...
    [Migration("20231221170502_Client.Data.Update")]
    partial class ClientDataUpdate
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Duende.IdentityServer.EntityFramework.Entities.ApiScope", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            Created = new DateTime(2023, 12, 21, 17, 4, 58, 676, DateTimeKind.Utc).AddTicks(9469),
            ...
            modelBuilder.Entity("Duende.IdentityServer.EntityFramework.Entities.ClientSecret", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            ClientId = 2,
                            Created = new DateTime(2023, 12, 21, 17, 4, 58, 677, DateTimeKind.Utc).AddTicks(798),
                            Type = "SharedSecret",
